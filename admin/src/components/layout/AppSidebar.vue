<template>
  ...
  >
    ...
    >
      <router-link to="/">
        <!-- Logo completo: visible cuando está expandido, en hover o en móvil -->
        <img
          v-if="isExpanded || isHovered || isMobileOpen"
          src="/evobike-logo.png"
          alt="Evobike Elite"
          width="150"
          height="50"
          class="object-contain"
        />
        <!-- Logo ícono: solo letra E cuando está colapsado en desktop -->
        <div
          v-else
          class="flex items-center justify-center w-9 h-9 rounded-lg bg-brand-500 text-white font-bold text-lg"
        >
          E
        </div>
      </router-link>
